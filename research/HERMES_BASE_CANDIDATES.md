...
| [Qwen3-0.6B](https://huggingface.co/Qwen/Qwen3-0.6B) / [Ollama tag](https://ollama.com/library/qwen3/tags) | Apache-2.0; public | Local manifest: 751.63M, 40,960 context | Local Q4_K_M artifact 522 MB; measured load 15.743 s; GPU allocation 567 MB at context 256 | Useful inference baseline, not the preferred clean SFT base because it is already post-trained | Local exact-format smoke passed through Olympus; no broad quality claim | Keep as frozen local serving baseline. Do not relabel or fine-tune it as Hermes Alpha. |
